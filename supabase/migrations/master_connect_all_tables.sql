-- ===================================================================================
-- PEPTECH Master Schema Migration: Connect All Database Tables & Module Links
-- Target Project: Supabase Cloud (ubzoovlhbnztjwemvrwo) & Local PostgreSQL (peptech_db)
-- Description: Establishes full relational integrity, foreign key constraints, indexes,
--              and bi-directional synchronization triggers for all business entities.
-- ===================================================================================

-- -----------------------------------------------------------------------------------
-- 1. ACCOUNT HOLDER & CUSTOMER RELATIONSHIPS
-- -----------------------------------------------------------------------------------

-- 1.1 Add customer_id directly to account_holder
ALTER TABLE public.account_holder 
  ADD COLUMN IF NOT EXISTS customer_id text;

DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_account_holder_customer') THEN
    ALTER TABLE public.account_holder
...
-- 1.2 Connect customer_account_holder junction table
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cah_customer') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cah_account_holder') THEN
    ALTER TABLE public.customer_account_holder
...
-- 1.3 Bi-directional sync trigger between account_holder and customer_account_holder
...
-- -----------------------------------------------------------------------------------
-- 2. PUBLISHABLE API KEY & SALES CHANNELS
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 3. CART & ORDER PAYMENT COLLECTIONS
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 5. STOCK LOCATIONS & SHIPPING OPTIONS
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 7. PRODUCT SALES CHANNEL, PRICES, INVENTORY & SHIPPING PROFILES
-- -----------------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------------
-- 8. CLAIMS, EXCHANGES, FULFILLMENT & RETURNS
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 10. LOCATION FULFILLMENT PROVIDERS & SETS
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 13. USER & ADMIN CONFIGURATIONS (LAYOUT, VIEWS, RBAC)
-- -----------------------------------------------------------------------------------
DO $$
BEGIN
...
-- -----------------------------------------------------------------------------------
-- 14. SUBSCRIPTIONS (CARTRIDGES & VIALS)
-- -----------------------------------------------------------------------------------
